...
class BatchController extends Controller
{
    ...
    public function footingConfigureAddPost(Request $request) {
        ...
        // $commonConfigure = new FootingConfigure();
        ...
        $beamConfigure = new FootingConfigure();
        ...
        return redirect()->route('footing_configure.details', ['columnConfigure' => $beamConfigure->id]);
    }
    ...
    public function footingConfigureDatatable() {
        ...
        return DataTables::eloquent($query)
            ->addColumn('project_name', function(FootingConfigure $columnConfigure) {
                return $columnConfigure->project->name??'';
            })
            ->addColumn('segment_name', function(FootingConfigure $columnConfigure) {
                return $columnConfigure->costingSegment->name??'';
            })
            ->addColumn('action', function(FootingConfigure $columnConfigure) {

                return '<a href="'.route('footing_configure.details', ['columnConfigure' => $columnConfigure->id]).'" class="btn btn-primary btn-sm">Details</a>';

            })
            ->editColumn('date', function(FootingConfigure $columnConfigure) {
    ...
    public function footingConfigureDetails(FootingConfigure $columnConfigure){
        // dd($columnConfigure);
        return view('estimate.footing_configure.details',compact('columnConfigure'));
    }

    public function footingConfigurePrint(FootingConfigure $columnConfigure){
        return view('estimate.footing_configure.print',compact('columnConfigure'));
    }
}
