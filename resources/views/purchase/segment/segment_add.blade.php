        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Project Segment Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('segment.add') }}">
                    @csrf
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row {{ $errors->has('segment_percentage') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Percentage for This Segment <span class="text-danger">*</span></label>

                            <div class="col-sm-10">
                                <input type="number" class="form-control" placeholder="Enter Percentage for Segment Project"
                                       name="segment_percentage" value="{{ old('segment_percentage') }}">
                        ...
                        <div class="form-group row {{ $errors->has('total_unit') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Total Segment Unit <span class="text-danger">*</span></label>

                            <div class="col-sm-10">
                                <input type="number" class="form-control" placeholder="Enter Percentage over Project"
                                       name="total_unit" value="{{ old('total_unit') }}">
