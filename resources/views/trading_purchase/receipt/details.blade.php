        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="row">
                 ...
                 <a target="_blank" href="{{ route('trading_purchase_receipt.print', ['order' => $order->id]) }}" class="btn btn-primary">Print</a>
                    </div>
                </div>
                <div id="prinarea">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Received Date</th>
                                    <td>{{ $order->received_at == null ? 'Not Received' : $order->received_at->format('j F, Y') }}</td>
                                </tr>
                                 <tr>
                                    <th>Note </th>
                                    <td>{{ $order->note??'' }}</td>
                        ...
                        <div class="col-md-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Mobile</th>
                                    <td>{{ $order->supplier->mobile_no }}</td>
                                </tr>
                                <tr>
                                    <th>Address</th>
