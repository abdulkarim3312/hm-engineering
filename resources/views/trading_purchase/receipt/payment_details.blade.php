                    ...
                    <div class="row">
                       <div id="printarea">
                           ...
                           <div class="col-xs-12 text-center">
                               <h4 ><span style="font-weight: 700" class="pull-left">Serial No: {{ $payment->purchaseOrder->id+10000 }}</span> <span style="font-size: 20px;font-weight: bold;text-transform: uppercase; margin-right: 100px;"> Debit Voucher </span><span style="text-align: center; font-weight: normal;font-size: 16px;position: absolute;text-transform: capitalize;right: 20px;"><b>Date: </b> {{ $payment->date->format('d-m-Y') }}</span></h4>
                           ...
                           <div class="col-xs-12">
                               ...
                               <table class="table table-bordered">
                                   <tbody>
                                   <tr>
                                       <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Being the amount paid to: <strong>{{ $payment->supplier->name }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 150px;"></p></td>
                                       <td width="20%" class="text-center"><strong>Amount</strong></td>
                                   </tr>
                                   <tr>
                                       <td style="border-bottom: 1px solid #fff !important;" colspan="7">Purpose of: <strong>{{ $payment->note }}</strong> <p style="border-bottom: 1px dotted #000;margin-left: 60px;"></p></td>
                                       <th rowspan="3" class="text-right"> {{ number_format($payment->amount, 2) }}</th>

                                   </tr>
                                   <tr>
                                       <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Address: <strong>{{ $payment->supplier->address }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 50px;"></p></td>

                                   </tr>

                                   <tr>
                                       <td style="border-right:1px solid #fff !important;border-bottom: 1px solid #fff !important;" colspan="5">Pay order/Cheque no./By Cash: <strong>{{$payment->cheque_no}}</strong><p style="border-bottom: 1px dotted #000;margin-left: 225px;"></p></td>
