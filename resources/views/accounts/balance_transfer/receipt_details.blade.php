...
@section('content')
    <div class="box">
        <div class="box-header">
            <a target="_blank" class="btn btn-default btn-lg" href="{{ route('balance_transfer_receipt_print',['balanceTransfer'=>$balanceTransfer->id]) }}"><i class="fa fa-print"></i></a>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table body-table table-bordered">
                        ...
                        <tr>
                            <td style="height: 187px;border-bottom: 1px solid #000 !important;"><b>Found Transfer From </b> {{ $balanceTransfer->sourceAccountHead->name }}
                                <br> <b>To</b>
                            ...
                            <td class="text-center" style="border-top: 1px solid #000 !important;border-bottom: 1px solid #000 !important;"><b>Cr.</b></td>
