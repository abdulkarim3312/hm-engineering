@extends('layouts.app')
@section('title','Cash/Cheque Receipts')
@section('style')
    <style>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('receipt.create') }}" class="btn btn-primary bg-gradient-primary pull-left">Cash/Cheque Receipt Create</a>
        ...
        $(function () {
            $('#table').DataTable({
                ...
                createdRow: function(row, data, dataIndex) {
                    $(row).find('td:eq(8)').addClass('bg-white-custom');
                },
                columns: [
                    { data: 'date',name:'date'},
