    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('petty_cash.add') }}">
                    @csrf
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                @else
                                    <tr class="product-item">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="number" step="any"  name="previous_balance[]" class="form-control previous_balance" value="0">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="number" step="any"  name="budget_amount[]" class="form-control budget_amount" value="0">
                                            </div>
                                        </td>

                                        <td>
                                            <div class="form-group">
                                                <input type="number" step="any"  name="required_amount[]" class="form-control required_amount" value="0">
                                            </div>
                                        </td>

                                        <td>
                                            <div class="form-group">
                                                <input type="number" step="any" class="form-control recommended_amount" name="recommended_amount[]" value="0">
                                            </div>
                                        </td>
