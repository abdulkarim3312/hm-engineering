                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input required type="text" id="from" autocomplete="off"
                                        name="from" class="form-control date-picker"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input required type="text" id="to" autocomplete="off"
                                        name="to" class="form-control date-picker"
                                        placeholder="Enter Start Date" value="{{ request()->get('end_date') ?? date('Y-m-d')  }}">
                                        {{-- <input type="text" class="form-control pull-right"
                                               id="to" name="to"
                                               value="{{ date('Y-m-d')  }}"
