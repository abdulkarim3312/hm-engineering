                    ...
                    <div class="row">
                        <div id="printarea">
                            ...
                            <div class="col-xs-12 text-center">
                                <h4 ><span style="font-weight: 700" class="pull-left">Serial No: {{ $payment->id+10000 }}</span> <span style="font-size: 20px;font-weight: bold;text-transform: uppercase; margin-right: 100px;"> Sale Voucher </span><span style="text-align: center; font-weight: normal;font-size: 16px;position: absolute;text-transform: capitalize;right: 20px;"><b>Date: </b> {{ $payment->date->format('d-m-Y') }}</span></h4>
                            ...
                            <div class="col-xs-12">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                    <tr>
                                        <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Being the amount paid from: <strong>{{ $payment->client->name }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 150px;"></p></td>
                                    ...
                                    <tr>
                                        <td style="border-bottom: 1px solid #fff !important;" colspan="7">Purpose of: <strong>
                                                ...
                                                {{ $payment->type==1 ? 'Booking Money' : ($payment->type==2 ? 'Down Payment 1' : ($payment->type==3 ? 'Down Payment 2' :'Installment-'.$payment->installment_no)) }}
