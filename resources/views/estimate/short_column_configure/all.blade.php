...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('short_column_configure.add') }}">Add Short Column Configure</a>
                    <hr>
    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('short_column_configure.datatable') }}',
                columns: [
                    {data: 'date', name: 'date'},
