...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('segment_configure.add') }}">Add Segment Configure</a>
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>Date</th>
                            <th>Configure No</th>
                            <th>Costing Segment</th>
                            <th>Segment Unit Type</th>
                            <th>Height</th>
                            <th>Width</th>
                            <th>Length</th>
                            <th>Action</th>
    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('segment_configure.datatable') }}',
                columns: [
                    {data: 'date', name: 'date'},
                    {data: 'segment_configure_no', name: 'segment_configure_no'},
                    {data: 'costing_segment', name: 'costingSegment.name'},
                    {data: 'unit_type', name: 'unit_type'},
                    {data: 'segment_height', name: 'segment_height'},
                    {data: 'segment_width', name: 'segment_width'},
                    {data: 'segment_length', name: 'segment_length'},
