    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('beam_configure.add') }}">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('beam_length') ? 'has-error' :'' }}">
                                    <label style="font-size: 14px;">Beam Length(Ft)</label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('grade_beam_length') ? 'has-error' :'' }}">
                                    <label style="font-size: 14px;"> Beam Height(Ft)</label>

                                    <div class="form-group">
                                        <input type="number" class="form-control" id="grade_beam_length" step="any"
                                               name="grade_beam_length" value="{{ old('grade_beam_length') }}" placeholder="Beam Height">
                                    </div>
                                    <!-- /.input group -->
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('grade_beam_width') ? 'has-error' :'' }}">
                                    <label style="font-size: 14px;">Beam Width(Ft)</label>

                                    <div class="form-group">
                                        <input type="number" class="form-control" id="grade_beam_width" step="any"
                                               name="grade_beam_width" value="{{ old('grade_beam_width') }}" placeholder="Beam Width">
                                    </div>
                                    <!-- /.input group -->
                                    ...
                                    <div class="form-group {{ $errors->has('beam_bar_costing') ? 'has-error' :'' }}">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" step="any"
                                                   name="beam_bar_costing" value="{{ 0 }}" placeholder="Enter Per Kg Bar Costing">
                                        </div>
                                        <!-- /.input group -->
