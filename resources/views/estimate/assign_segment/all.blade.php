...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('assign_segment.add') }}">Add Assign Segment</a>
    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('assign_segment.datatable') }}',
                columns: [
                    {data: 'date', name: 'date'},
                    {data: 'assign_segment_no', name: 'assign_segment_no'},
                    {data: 'estimate_project', name: 'estimateProject.name'},
