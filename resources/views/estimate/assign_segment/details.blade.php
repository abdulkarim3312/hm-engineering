                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="text-left">
                            ...
                            <span  style="border: 1px solid #999;padding: 5px">SC#{{ $assignSegment->id }}</span>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="text-right">
                            <span  style="border: 1px solid #999;padding: 5px">Date :</span>
                            <span  style="border: 1px solid #999;padding: 5px">{{ $assignSegment->date }}</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div style="padding:5px; width:100%; text-align:center;">
                        <h4><strong>Estimate Project Name: {{$assignSegment->estimateProject->name }}</strong></h4>
                    </div>
                </div>
                @foreach($assignSegment->assignSegmentItems as $assignSegmentItem)
                <div class="row">
                    <div style="padding:5px; width:100%; text-align:center;">
...
{{--                    </div>--}}
                    ...
                    <div class="col-xs-3"><strong>Minimum Quantity</strong></div>
                    <div class="col-xs-3"><strong>Assign Quantity</strong></div>
...
{{--                    <div class="col-xs-3 text-right"><strong>{{number_format($assignSegment->total,2)}}</strong></div>--}}
{{--                    <div class="col-xs-3 text-right"><strong>{{number_format($assignSegment->total,2)}}</strong></div>--}}
{{--                </div>--}}
{{--                <div class="row" style="padding: 5px;border: 1px solid #000;">--}}
{{--                    <div class="col-xs-12"><strong>Amount In Word (in BDT):</strong> {{ $assignSegment->amount_in_word }}</div>--}}
{{--                </div>--}}
{{--                <div class="row" style="padding: 5px;border: 1px solid #000;">--}}
{{--                    <div class="col-xs-12"><strong>Narration: </strong> {{ $assignSegmentItem->note }}</div>--}}
{{--                </div>--}}
                @endforeach
                <div class="row" style="padding: 5px;border: 1px solid #000;">
                    <div class="col-xs-12"><strong>Narration: </strong> {{ $assignSegment->note }}</div>
                </div>
