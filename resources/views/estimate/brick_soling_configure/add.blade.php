        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Bricks Soling Configure Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('bricks_soling_configure.add') }}">
                    @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th width="15%">Nos</th>
                                    <th width="15%">Unit Price(Per Sft)</th>
                                ...
                                @else
                                    <tr class="project-item">
                                        ...
                                        <td class="sub-total">0.00 (Sft)</td>
                                        <td class="text-center">
                                            <a role="button" class="btn btn-danger btn-sm btn-remove">X</a>
                                        </td>
                                    </tr>
...
@section('script')
    ...
    <script>
        ...
        function calculate() {
            ...
            $('#total-area').html(totalArea.toFixed(2) +' '+'Psc');
        }
