...
@section('title')
   Bricks Soling Configure Details
@endsection
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a target="_blank" href="{{ route('bricks_soling_configure.print', ['bricksSolingConfigure' => $bricksSolingConfigure->id]) }}" class="btn btn-primary">Print</a>
                        </div>
                    </div>
                    <div id="prinarea">
