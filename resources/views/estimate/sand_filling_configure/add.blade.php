        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Sand Filling Configure Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('sand_filling_configure.add') }}">
                    @csrf
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            $('body').on('keyup','.length, .width, .height, .quantity', function () {
                calculate();
            });
