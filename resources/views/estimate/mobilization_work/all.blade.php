...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('mobilization_work.add') }}">Add Mobilization Work Costing</a>
    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('mobilization_work.datatable') }}',
                columns: [
                    {data: 'date', name: 'date'},
                    {data: 'project', name: 'project'},
                    {data: 'costing_no', name: 'costing_no'},
