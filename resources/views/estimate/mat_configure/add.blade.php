        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Mat Configure Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('mat_configure.add') }}">
                    @csrf
                                ...
                                <div class="form-group {{ $errors->has('costing_segment_quantity') ? 'has-error' :'' }}">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="costing_segment_quantity" step="any"
                                               name="costing_segment_quantity" value="{{ old('costing_segment_quantity') }}" placeholder="Mat Quantity">
                                    </div>
                                    <!-- /.input group -->
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('segment_length') ? 'has-error' :'' }}">
                                    <label>Mat Length(Ft)</label>

                                    <div class="form-group">
                                        <input type="number" class="form-control" id="segment_length" step="any"
                                               name="segment_length" value="{{ old('segment_length') }}" placeholder="Mat Length">
                                    </div>
                                    <!-- /.input group -->
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('segment_width') ? 'has-error' :'' }}">
                                    <label>Mat Width(Ft)</label>

                                    <div class="form-group">
                                        <input type="number" class="form-control" id="segment_width" step="any"
                                               name="segment_width" value="{{ old('segment_width') }}" placeholder="Mat Width">
                                    </div>
                                    <!-- /.input group -->
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('segment_thickness') ? 'has-error' :'' }}">
                                    <label style="font-size: 15px;">Mat Thickness(Ft)</label>

                                    <div class="form-group">
                                        <input type="number" class="form-control" id="segment_thickness" step="any"
                                               name="segment_thickness" value="{{ old('segment_thickness') }}" placeholder="Mat Thickness">
                                    </div>
                                    <!-- /.input group -->
