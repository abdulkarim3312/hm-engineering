                        ...
                        <div id="printarea">
                            ...
                            <div class="col-xs-12">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                    <tr>
                                        <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Project Name: &nbsp;&nbsp;<strong>{{ $loan->project->name }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 150px;"></p></td>
                                    ...
                                    <tr>
                                        <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Address: <strong>{{ $loan->project->address }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 50px;"></p></td>
