        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('loan.add') }}">
                    @csrf
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('loan_from') ? 'has-error' :'' }}" >
                            <label class="col-sm-2 control-label">Loan From <span style="color: red">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="myDiv form-group {{ $errors->has('client') ? 'has-error' :'' }}" id="showOne">
                        ...
                        <div class="myDiv form-group {{ $errors->has('project') ? 'has-error' :'' }}" id="showTwo">
                            <label class="col-sm-2 control-label">Project  <span style="color: red"></span></label>
                        ...
                        <div class="form-group {{ $errors->has('loan_holder') ? 'has-error' :'' }}"  id="showThree">
                        ...
                        <div class="form-group {{ $errors->has('interest') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" placeholder=""
                                       name="interest" value="{{ old('interest') }}">
