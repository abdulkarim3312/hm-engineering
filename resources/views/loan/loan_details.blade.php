...
@section('title')
  {{ $loans[0]->loanHolder->name }} 's loans
@endsection
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($loans as $loan)
                            ...
                            <tr>
                                ...
                                <td>
                                   <a class="btn btn-primary btn-sm " href="{{route('holder_loan_print',['loan'=>$loan->id,'type'=>$loan->loan_type])}}" > Print </a>
                                    <a class="btn btn-info btn-sm " href="{{route('loan_payment_details',['loan'=>$loan->id,'type'=>$loan->loan_type])}}" > Details </a>
                               </td>
                            </tr>
                        @endforeach
