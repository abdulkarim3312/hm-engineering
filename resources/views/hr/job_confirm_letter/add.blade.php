        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Job Confirmation Letter Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('job_letter_add') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Job Confirmation Letter Writing</label>
