                    ...
                    <form action="{{route('employee.attendance')}}" method="post">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input id="attend_date" value="{{old('date')}}" name="attend_date" type="text" class="form-control" autocomplete="off">
                        ...
                        <table id="table" class="table table-bordered table-striped ">
                            ...
                            @foreach ($employees as $employee)
                                ...
                                <tr>
                                    ...
                                    <td><input class="timepicker present_time"  name="present_time_{{ $employee->id }}" type="text"></td>
