        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Job Promotion Letter Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('job_promotion_letter_update', $letter->id) }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="letter_type" value="3">
                    <div class="box-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Job Promotion Letter Writing</label>
